    ...
    <div class="col-md-7">
      <article class="right-col text-center">
        <div class="text">
          ...
          <p class="text-light">
			  <a href="https://houseforpurchase.com/wp-content/uploads/2023/04/CONSUMER-PROTECTION-NOTICE.jpg" target="_blank" style="color: white;">
				  Texas Real Estate Commission Consumer Protection Notice
			  </a>	  
				  | 
			  <a href="https://houseforpurchase.com/wp-content/uploads/2022/09/Information_about_Brokerage_Services_SellerLandlord_-_112015_ts38625.pdf" target="_blank" style="color: white;">
			  		Texas Real Estate Commission Information About Brokerage Services 
			  </a>	  
			  HOUSEforPURCHASE.com® agents are licensed as either brokers or salespersons by the Texas Real Estate Commission.
            </p>
        </div>
      </article>
    </div>
